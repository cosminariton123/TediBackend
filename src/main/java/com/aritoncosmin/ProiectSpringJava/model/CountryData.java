...
@Entity
@Table(name = CountryData.tableName)
public class CountryData extends Data{

    public static final String tableName = "countries_data";
    public static final String countryField = "country_id";

    @OneToOne
    @JoinColumn(name = CountryData.countryField)
    private Country country;

    public CountryData() {
    }

    public CountryData(Long year, Long population, Double gdp, Double co2, Double co2_per_capita, Double co2_per_gdp, Double energy_per_capita, Double energy_per_gdp, Double methane, Double methane_per_capita, Double nitrous_oxide, Double nitrous_oxide_per_capita, Double share_of_temperature_change_from_ghg, Double temperature_change_from_ch4, Double temperature_change_from_co2, Double temperature_change_from_ghg, Double temperature_change_from_n2o, Double total_ghg, Country country) {
